...
class Qwen3:
    def __new__(cls, model_path: str, args: Any) -> Any:
        # 根据环境变量选择加载方式
        if os.environ.get("use_vllm", "True") == "True":
            from models.Qwen3.Qwen3_vllm import Qwen3
            return Qwen3(model_path, args)  # 添加返回语句
        else:
            from models.Qwen3.Qwen3_hf import Qwen3
            return Qwen3(model_path, args)

@LLMRegistry.register("openPangu_1b") 
class OpenPangu_1b:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.openPangu_1b.openPangu_1b_vllm import OpenPangu
        return OpenPangu(model_path, args)

@LLMRegistry.register("openPangu_7b") 
class OpenPangu_7b:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.openPangu_7b.openPangu_1b_vllm import OpenPangu
        return OpenPangu(model_path, args)
